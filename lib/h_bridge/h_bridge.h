...
#define INPUT_RIGHT_1       GPIO_NUM_33//AIN1
#define INPUT_RIGHT_2       GPIO_NUM_32//AIN2

#define INPUT_LEFT_1        GPIO_NUM_14//BIN1
#define INPUT_LEFT_2        GPIO_NUM_12//BIN2

#define PWM_GPIO_LEFT       GPIO_NUM_13 //PWMB
#define PWM_GPIO_RIGHT      GPIO_NUM_35 //PWMA
